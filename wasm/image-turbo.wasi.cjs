// napi-rs-artifact-metadata:{"version":2,"rootEntry":"index.js","exports":["BlendMode","blurhash","blurhashSync","codecBackend","composite","compositeSync","crop","CropGravity","cropSync","dominantColors","dominantColorsSync","FitMode","HashAlgorithm","HashSize","ImageFormat","imageHash","imageHashDistance","imageHashDistanceSync","imageHashSync","metadata","metadataSync","resize","ResizeFilter","resizeSync","smartCrop","smartCropAnalyze","smartCropAnalyzeSync","smartCropSync","stripExif","stripExifSync","TensorDtype","TensorLayout","TensorNormalization","thumbhash","thumbhashSync","thumbhashToRgba","thumbhashToRgbaSync","thumbnail","thumbnailBuffer","thumbnailBufferSync","ThumbnailFormat","thumbnailSync","toJpeg","toJpegSync","toPng","toPngSync","toTensor","toTensorSync","toWebp","toWebpSync","transform","transformSync","version","writeExif","writeExifSync"],"managedRootEntries":["browser.js","index.js","image-turbo.wasm","image-turbo.debug.wasm"]}
/* eslint-disable */
...
let __wasmFilePath = __nodePath.join(__dirname, 'image-turbo.wasm32-wasi.wasm')
const __wasmDebugFilePath = __nodePath.join(__dirname, 'image-turbo.wasm32-wasi.debug.wasm')

if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  __wasmFilePath = __wasmDebugFilePath
} else if (!__nodeFs.existsSync(__wasmFilePath)) {
  const __wasiPackageEntry = require.resolve('imgkit-wasm32-wasi')
  const __packagedWasmFilePath = __nodePath.join(
    __nodePath.dirname(__wasiPackageEntry),
    'image-turbo.wasm32-wasi.wasm',
  )
  if (!__nodeFs.existsSync(__packagedWasmFilePath)) {
    throw new Error(
      'imgkit-wasm32-wasi is installed but is missing image-turbo.wasm32-wasi.wasm.',
    )
  }
...
module.exports.blurhash = __napiModule.exports.blurhash
module.exports.blurhashSync = __napiModule.exports.blurhashSync
module.exports.codecBackend = __napiModule.exports.codecBackend
module.exports.composite = __napiModule.exports.composite
module.exports.compositeSync = __napiModule.exports.compositeSync
module.exports.crop = __napiModule.exports.crop
module.exports.CropGravity = __napiModule.exports.CropGravity
module.exports.cropSync = __napiModule.exports.cropSync
module.exports.dominantColors = __napiModule.exports.dominantColors
module.exports.dominantColorsSync = __napiModule.exports.dominantColorsSync
module.exports.FitMode = __napiModule.exports.FitMode
module.exports.HashAlgorithm = __napiModule.exports.HashAlgorithm
module.exports.HashSize = __napiModule.exports.HashSize
module.exports.ImageFormat = __napiModule.exports.ImageFormat
module.exports.imageHash = __napiModule.exports.imageHash
module.exports.imageHashDistance = __napiModule.exports.imageHashDistance
module.exports.imageHashDistanceSync = __napiModule.exports.imageHashDistanceSync
module.exports.imageHashSync = __napiModule.exports.imageHashSync
module.exports.metadata = __napiModule.exports.metadata
module.exports.metadataSync = __napiModule.exports.metadataSync
module.exports.resize = __napiModule.exports.resize
module.exports.ResizeFilter = __napiModule.exports.ResizeFilter
module.exports.resizeSync = __napiModule.exports.resizeSync
module.exports.smartCrop = __napiModule.exports.smartCrop
module.exports.smartCropAnalyze = __napiModule.exports.smartCropAnalyze
module.exports.smartCropAnalyzeSync = __napiModule.exports.smartCropAnalyzeSync
module.exports.smartCropSync = __napiModule.exports.smartCropSync
module.exports.stripExif = __napiModule.exports.stripExif
module.exports.stripExifSync = __napiModule.exports.stripExifSync
module.exports.TensorDtype = __napiModule.exports.TensorDtype
module.exports.TensorLayout = __napiModule.exports.TensorLayout
module.exports.TensorNormalization = __napiModule.exports.TensorNormalization
module.exports.thumbhash = __napiModule.exports.thumbhash
module.exports.thumbhashSync = __napiModule.exports.thumbhashSync
module.exports.thumbhashToRgba = __napiModule.exports.thumbhashToRgba
module.exports.thumbhashToRgbaSync = __napiModule.exports.thumbhashToRgbaSync
module.exports.thumbnail = __napiModule.exports.thumbnail
module.exports.thumbnailBuffer = __napiModule.exports.thumbnailBuffer
module.exports.thumbnailBufferSync = __napiModule.exports.thumbnailBufferSync
module.exports.ThumbnailFormat = __napiModule.exports.ThumbnailFormat
module.exports.thumbnailSync = __napiModule.exports.thumbnailSync
module.exports.toJpeg = __napiModule.exports.toJpeg
module.exports.toJpegSync = __napiModule.exports.toJpegSync
module.exports.toPng = __napiModule.exports.toPng
module.exports.toPngSync = __napiModule.exports.toPngSync
module.exports.toTensor = __napiModule.exports.toTensor
module.exports.toTensorSync = __napiModule.exports.toTensorSync
module.exports.toWebp = __napiModule.exports.toWebp
module.exports.toWebpSync = __napiModule.exports.toWebpSync
...
module.exports.writeExif = __napiModule.exports.writeExif
module.exports.writeExifSync = __napiModule.exports.writeExifSync
